...
class NewUtils {
    ...
    public static function pager($totalRecord, $currentPage, $limit, $half = 5) {
        ...
        $html .= "<li class='paginate_button next $disabled' id='example1_next'><a href='{$href}' aria-controls='example1' data-dt-idx='".($currentPage+1)."' tabindex='0'>下一页</a></li></ul> </div> </div>";
        return $html;
    }
    ...
    public static function pagerLimit($limit_arr) {
        $html = ' <div class="col-sm-5"> <div class="dataTables_length" id="example1_length"> <label>显示&nbsp;
